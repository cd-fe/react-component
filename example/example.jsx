var Test = React.createClass({
    ...
    render:function() {
        ...
        return <div>
            <RUI.DatePicker value={Date.now()} format={new RUI.DateFormatter("Y-m-d H:i:s")} range={false} />
            <br/>
            <RUI.DatePicker value={Date.now()} format={new RUI.DateFormatter("Y-m-d H:i:s")} range={true} />
            <br/>
