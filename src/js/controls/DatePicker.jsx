                ...
                <div className={defaultClass+'-row'}>
                    {this.props.range ? (
                        <div className={defaultClass+'-row-range'}>
                            ...
                            <Calendar source={{start:this.state.startValuePreview, end:this.state.endValuePreview}} value={this.state.endValuePreview || this.dateNow(Date.now() + 86400 * 1000)} onChange={this.endCalendarChange} range={"end"} />
                        </div>
                    ) : (
                        <Calendar
